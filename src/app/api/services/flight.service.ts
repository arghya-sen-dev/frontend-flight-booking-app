...
export class FlightService extends BaseService {
  ...
  }): Observable<StrictHttpResponse<Array<Flight>>> {
    const rb = new RequestBuilder(
      this.rootUrl,
      FlightService.SearchFlightPath,
      'get'
    );
    if (params) {
  ...
  searchFlight$Plain(params?: {
    ...
    destination?: string;
    numberOfPassengers?: number;
  }): Observable<Array<Flight>> {
    return this.searchFlight$Plain$Response(params).pipe(
      map((r: StrictHttpResponse<Array<Flight>>) => r.body as Array<Flight>)
    );
  }
   ...
   * This method sends `application/*+json` and handles request body of type `application/*+json`.
   */
  bookFlight(params?: { body?: BookDto }): Observable<void> {
   ...
   * This method doesn't expect any request body.
   */
  findFlight$Plain(params: { id: string }): Observable<Flight> {
   ...
   * This method doesn't expect any request body.
   */
  findFlight(params: { id: string }): Observable<Flight> {
